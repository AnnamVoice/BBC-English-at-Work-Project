...
class EnglishCollectionViewCell: UICollectionViewCell {
    ...
    func setupView(){
        ...
        //        textLabelView.bottomAnchor.constraint(equalTo: self.detailTextLabelView.topAnchor, constant: 0).isActive = true
        textLabelView.heightAnchor.constraint(equalToConstant: 20).isActive = true
        
        //Constraint detailLabelView
        ...
        //        detailTextLabelView.heightAnchor.constraint(equalToConstant: 25).isActive = true
